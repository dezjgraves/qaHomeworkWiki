import { elementIsSelected } from "selenium-webdriver/lib/until";
...
class Bird extends Animal {
  ...
  fly(): string {
    ...
    else return `The ${this.name} is a flightless bird don't rub it in.`
    }
}
...
describe("Testing animals", () => {
  ...
  describe("Birds", () => {
    ...
    it("might be able to fly", () => {
      ...
      expect(emu.fly()).toBe("The emu is a flightless bird don't rub it in.");
    });
  });
});
